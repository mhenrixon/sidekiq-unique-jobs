# -*- encoding: utf-8 -*-
# stub: rubocop-mhenrixon 0.89.1 ruby lib
...
Gem::Specification.new do |s|
  ...
  if s.respond_to? :specification_version then
    ...
    if Gem::Version.new(Gem::VERSION) >= Gem::Version.new('1.2.0') then
      s.add_runtime_dependency(%q<rubocop>.freeze, ["~> 0.89"])
      s.add_runtime_dependency(%q<rubocop-performance>.freeze, ["~> 1.7"])
      s.add_runtime_dependency(%q<rubocop-rake>.freeze, ["~> 0.5"])
      s.add_runtime_dependency(%q<rubocop-rspec>.freeze, ["~> 1.42"])
