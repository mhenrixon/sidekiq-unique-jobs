...
-- The client should only set expiration for until_expired
-- The server should set expiration for all other jobs
if lock == "until_expired" and expiration then
  ...
  redis.call('EXPIRE', unique_digest, expiration)
end
